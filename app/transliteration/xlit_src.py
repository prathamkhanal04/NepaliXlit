def XlitEngine(
    ...
    if model_type == "transformer":
        if src_script_type in {"roman", "latin", "en"}:
            ...
            return XlitEngineTransformer_En2Indic(
                lang2use, beam_width=beam_width, rescore=rescore
            )
        elif src_script_type == "indic":
            from .transformer import XlitEngineTransformer_Indic2En

            return XlitEngineTransformer_Indic2En(
                beam_width=beam_width, rescore=rescore
            )
